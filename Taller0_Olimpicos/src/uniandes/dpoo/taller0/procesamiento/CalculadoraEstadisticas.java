...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el pais con el nombre del atleta indicado
	 * @param nombre EL nombre del atleta que se esta buscando 
	 * @return El pais de procedencia del atleta o null si no se encuentra.
	 */
	
	public String PaisporAtleta(String nombre)
	{
