...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país por nombre de Atleta");
	...
	private void ejecutarPaisNombre()
	{
		System.out.println("/n" + "País de procedencia del Atleta " + "/n");
		
		String nombre = input("Por favor ingrese el nombre del Atleta ");
		String pais = calculadora.PaisporAtleta(nombre);
		if (pais != null)
		{
			System.out.println("El atleta " + nombre + " representa a " + pais);	
		}
		else
		{
